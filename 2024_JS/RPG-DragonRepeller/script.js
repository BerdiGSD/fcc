...
function buyWeapon() {
    if (currentWeapon < weapons.length-1) {
        if (gold >= 30) {
            ...
            //  Remember that the "+" in the previous line is the concatenation operator
        } else {
...
function goFight () {
    ...
    monsterStats.style.display = "block"; /*similar to updating a 
...
function attack() {
    ...
    healthText.innerText = health;
    monsterHealthText.innerText = monsterHealth; // Stopped at step 125;
} 
