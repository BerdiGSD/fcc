...
const previousButton = document.getElementById("pause");
...
const shuffle = () => {
    ...
    const currSong = userData?.songs[0];

        playSong(currSong.id); 
};
        ...
        <li id="song-${song.id}" class="playlist-song">
            ...
            <button class="playlist-song-delete" aria-label="Delete ${song.title}" onclick="deleteSong(${song.id})">
                <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    10.8143C4.94102 10.5316 4.88969 10.0281 5.21121 9.68974L6.8168 7.99999L5.21122 6.31026C4.8897 5.97188 
